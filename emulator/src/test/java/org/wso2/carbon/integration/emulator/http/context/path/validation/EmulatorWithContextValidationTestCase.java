...
package org.wso2.carbon.integration.emulator.http.context.path.validation;
...
import org.wso2.carbon.integration.emulator.http.params.HeaderOperation;
import org.wso2.carbon.integration.emulator.http.server.contexts.HttpServerOperationBuilderContext;

import static org.wso2.carbon.integration.emulator.http.server.contexts.HttpServerConfigBuilderContext.configure;
import static org.wso2.carbon.integration.emulator.http.server.contexts.HttpServerResponseBuilderContext.response;
...
public class EmulatorWithContextValidationTestCase {
    ...
    private HttpServerOperationBuilderContext startHttpEmulator() {
        return Emulator.getHttpEmulator().server().given(configure().host("127.0.0.1").port(6065).context("/users"))
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST).withPath("*").withBody("User4")
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST).withPath("/user14").withBody("User14")
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST).withPath("/user15").withBody("User15")
