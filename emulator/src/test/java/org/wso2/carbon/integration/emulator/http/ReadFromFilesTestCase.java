...
public class ReadFromFilesTestCase {
    ...
    private HttpServerOperationBuilderContext startHttpEmulator() {
        return Emulator.getHttpEmulator().server().given(HttpServerConfigBuilderContext.configure().host("127.0.0.1").port(6065).context("/users"))

                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST).withPath("/user1").withBody("User1")
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST).withPath("/user2").withBody("User2"))
